...
The model explains about 31% of the deviance and has an adjusted R-squired of 0.349, which is reasonable for behavioral auction data. Overall, the results suggest that while bid amount is a major driver of winning probability, location-based competition also plays an important role.
...
```{r}
# showing price in relation to probability of winning a bid 

ggplot(test_data, aes(x = PRICE_final, y = pred_prob)) +
  geom_point(alpha = 0.1, color = "darkblue") +
  geom_smooth(color = "red", se = FALSE, size = 1.2) +
  labs(
