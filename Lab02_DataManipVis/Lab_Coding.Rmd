...
bids <- read_parquet("C:/Users/LillyKennedy/OneDrive - Portland Psychotherapy/Documents/Lab01_IC/data/bids_data_vDTR.parquet") #edit this path to your path to the data file
glimpse(bids)
