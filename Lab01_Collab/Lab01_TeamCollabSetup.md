...
-Collaboration policies: -majority vote if discussion fails to resolve
issue -consensus deliverables, we all agree on deliverables before they
become to dos

-WIP limits: 2 per person -Definition of done:documented, peer-reviewed,
reproducible -Who reviews the work: we will set a peer-reviewer when
assigning and agreeing on tasks
