...
bids <- bids %>%
  mutate(
    valid_length   = str_length(DEVICE_GEO_ZIP) == 5,
    valid_numeric  = str_detect(DEVICE_GEO_ZIP, "^[0-9]{5}$"),
    valid_oregon   = str_detect(DEVICE_GEO_ZIP, "^97[0-9]{3}$")
  )
#
bids %>% count(valid_oregon)
