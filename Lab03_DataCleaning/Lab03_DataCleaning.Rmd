...
The code is not elegent and not the easiest to modify without getting into the guts of the code. Happy to fix if needed.
...
Again, i am using the code from the src/data_cleaning.r file. I exctract numeric values from the RESPONSE_TIME column.
